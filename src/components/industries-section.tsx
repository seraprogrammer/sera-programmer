...
const industries = [
  {
    name: "Fintech",
    description: "Innovative solutions for financial technology companies, from payment processing to wealth management.",
    icon: Building2,
    color: "bg-chart-1/10 text-chart-1",
  },
  {
    name: "Healthcare",
    description: "HIPAA-compliant platforms and interfaces for healthcare providers, patients, and medical services.",
    icon: HeartPulse,
    color: "bg-chart-3/10 text-chart-3",
  },
  {
    name: "Education",
    description: "Learning management systems and educational platforms that enhance the teaching and learning experience.",
    icon: GraduationCap,
    color: "bg-chart-2/10 text-chart-2",
  },
  {
    name: "AI Chatbot",
    description: "Intelligent conversational interfaces powered by advanced AI to enhance customer engagement.",
    icon: Bot,
    color: "bg-chart-4/10 text-chart-4",
  },
  {
    name: "Non-Profit",
    description: "Digital solutions for non-profit organizations to maximize their impact and reach.",
    icon: Heart,
    color: "bg-chart-5/10 text-chart-5",
  },
  {
    name: "E-Commerce",
    description: "Scalable and secure online shopping experiences with seamless payment integration.",
    icon: ShoppingBag,
      ...
      <div className="container mx-auto px-6">
        ...
        >
          {industries.map((industry, index) => (
            ...
            >
              <div className={cn("absolute -z-10 inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300", industry.color)} 
